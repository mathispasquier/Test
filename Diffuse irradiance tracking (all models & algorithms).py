...
filename = r'C:\Users\mathi\Documents\GitHub\2023\Risø Data formatted 2023.csv' # Name and path for the data file
...
# Calculating irradiance variability
...
IDEAL_astronomical_tracking.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Ideal\Astronomical tracking',index=True,mode='w')
...
IDEAL_brute_force_search_infinite_speed.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Ideal\Brute force search infinite speed',index=True,mode='w')
...
IDEAL_brute_force_search_limited_speed.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Ideal\Brute force search limited speed',index=True,mode='w')
...
print('Ideal CENER')
IDEAL_CENER.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Ideal\CENER',index=True,mode='w')
...
print('Ideal binary')
IDEAL_binary_mode.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Ideal\Binary mode',index=True,mode='w')
...
REAL_TIME_astronomical_tracking.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Real time\Astronomical tracking',index=True,mode='w')
...
REAL_TIME_brute_force_search_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Real time\Brute force search limited speed extended',index=True,mode='w')
...
REAL_TIME_TERABASE_brute_force_search_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Real time\Brute force search limited speed & TeraBase extended',index=True,mode='w')
...
print('Real CENER')
REAL_TIME_CENER_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Real time\CENER extended',index=True,mode='w')
...
print('Real binary') 
REAL_TIME_binary_mode_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Real time\Binary mode extended',index=True,mode='w')
...
FORECAST_brute_force_search_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Forecast\Brute force search limited speed',index=True,mode='w')
...
FORECAST_CENER_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Forecast\CENER extended',index=True,mode='w')
...
FORECAST_binary_mode_extended.to_csv(r'C:\Users\mathi\Documents\GitHub\2023\15min resolution, VI 10\Forecast\Binary mode',index=True,mode='w')